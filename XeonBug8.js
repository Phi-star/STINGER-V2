...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Asia/Kolkata').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `This is BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. You are still awake 😯, Night owl alert! Time to cozy up and catch some Z's. Goodnight 🌃 `
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `This is BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. Almost time to wrap up the day! Relax, take a load off, and enjoy your evening. Anyways Good evening 🌆`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `This is BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. Almost time to wrap up the day! Relax, take a load off, and enjoy your evening. Anyways Good evening 🌆`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `This is BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. Melting over here! Good Afternoon, stay cool 🆒`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `This is BIG DADDY 👑 created by ᴘʜ✦ꜱᴛᴀʀ. . Morning, shaaa! Hope you slept like a king/queen ☺️`
 } 
...
senddocu(buffer)
    ...
    case 'autostatusview':{
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://ibb.co/dgjDCcW',
            ...
            case 'tagall':
                ...
                let teks = `*👥 BIG DADDY has Tag All*
...
💻 BIG DADDY Info Server
RAM: ${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}

_BIG DADDY NodeJS Memory Usage🚧_
${Object.keys(used).map((key, _, arr) => `${key.padEnd(Math.max(...arr.map(v=>v.length)),' ')}: ${formatp(used[key])}`).join('\n')}

${cpus[0] ? `_BIG DADDY Total CPU Usage🧑‍🔧_
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Wag wan ${pushname}👋\nWant to Buy Premium? Just chat with Philip 😉👉09128019141`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'donasi':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    text: 'monie point 🏦 Acct No: 9128019141😊 Acct Name: SALIU PHILIP OTHUAMHO\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
case "xandroid": {
  ...
  sendMessageWithMentions(
    ...
    " Using *" + command + "* ✅\n\nPause for 2mins so that BIG DADDY doesn't get your account banned✅. BUG was sent useing DEADPOOL 😈", 
    [whatsappNumber]
  );
}
break;
case "xios": {
  ...
  var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "2349128019141") {
    return;
  }
  if (contactInfo.length == 0) {
    return replygcxeon("The number is not registered on WhatsApp");
...
await replygcxeon(`BIG DADDY has Successfully Send Bug to ${xeonyvictim} Using ${command}. ✅`)
}
break
...
case 'lockotp': case 'tempban': {
  ...
  sendMessageWithMentions(
    "BIG DADDY HAS SUCCESSFULLY ACTIVATED OTP LOCK😌 To @" + xeonMention.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause for 2mins so that BIG DADDY doesn't get your account banned✅. BUG was sent useing DEADPOOL 😈", 
    [xeonMention]
  );
  try {
...
║╔══╝─║╔═╗║─║╔╗╔╗║
║╚══╗─║║─║║─║║║║╔╝
╚═══╝─╚╝─╚╝─╚╝╚╝    *BIG DADDY* - *king of bots 👑🛡️💀*
╰━━━━━━━━━━━━━━━━━━━━━━━━━╯
*USING DEADPOOL BUG* ⚡💥
┃❁️ _ᴏᴡɴᴇʀ:_ ᴘʜ✦ꜱᴛᴀʀ ᴛᴇᴄʜ 🦸
┃❁️ _ᴠᴇʀꜱɪᴏɴ:_ 0.0.0 🧪
┃❁️ _ᴍᴏᴅᴇʟ:_ ʙɪɢ ᴅᴀᴅᴅʏ 🚨👑
